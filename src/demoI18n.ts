...
export const demoUi = {
  es: {
    ...
    bookingHold:'Reserva temporal · solo demo', continueCheckout:'Continuar al checkout demo', continueNoPayment:'Continuar · no requiere pago', holdSafe:'Solo modo Template · esta reserva temporal no bloquea ningún horario real.',
    ...
    confirmBooking:'Confirmar reserva demo →', checksVisual:'Estas verificaciones son únicamente una simulación visual. No se contacta ningún servicio externo.', demoConfirmed:'PRUEBA CONFIRMADA', bookingComplete:'Experiencia de reserva completada.',
    bookingStatus:'Estado de la reserva', confirmedDemo:'CONFIRMADA · PRUEBA', payment:'Pago', verifiedDemo:'VERIFICADO · PRUEBA', notRequired:'NO REQUERIDO', calendar:'Calendario', eventReady:'EVENTO LISTO · DEMO', done:'Finalizar',
  ...
  en: {
    ...
    bookingHold:'Temporary booking hold · demo only', continueCheckout:'Continue to demo checkout', continueNoPayment:'Continue · no payment required', holdSafe:'Test mode only · this hold does not block any real calendar slot.',
    ...
    confirmBooking:'Confirm demo booking →', checksVisual:'These checks are visual simulation only. No external service is contacted.', demoConfirmed:'TEST CONFIRMED', bookingComplete:'Booking experience complete.',
    bookingStatus:'Booking status', confirmedDemo:'CONFIRMED · TEST', payment:'Payment', verifiedDemo:'VERIFIED · TEST', notRequired:'NOT REQUIRED', calendar:'Calendar', eventReady:'EVENT READY · DEMO', done:'Done',
