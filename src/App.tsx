...
function App(){
  ...
  return <>
    ...
    <main id="top" className="wf-home">
      ...
      <section className="section navy wf-home-ai" data-scroll-sound="major"><div className="shell split">
      ...
      <section className="section navy" data-scroll-sound="major"><div className="shell split"><Heading data={t.booking} invert/><div className="booking-flow">{['Service','Employee','Date','Time','Payment','Confirmed'].map((x,i)=><div key={x}><small>0{i+1}</small><strong>{x}</strong>{i<5&&<span>↓</span>}</div>)}</div></div></section>
