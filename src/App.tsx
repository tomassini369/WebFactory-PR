...
const content = {
  es: {
    ...
    hero: {
      ...
      text:'Crea, publica y administra tu website comercial desde un portal privado. Usa WebFactory AI con Claude para construir o modificar contenido y estructura dentro del mismo Builder. Comienza con 48 horas gratis y sin tarjeta.',
    ...
    builder:['WEBFACTORY BUILDER + AI','Avanzado por dentro. Fácil por fuera.','Configura tu negocio paso a paso o pídele a WebFactory AI con Claude que proponga estructura, contenido bilingüe, catálogo y equipo dentro del mismo Builder.'],
  ...
  en: {
    ...
    hero: {
      ...
      text:'Create, publish and manage your commerce website from a private portal. Use WebFactory AI with Claude to build or modify content and structure inside the same Builder. Start with 48 hours free and no card.',
    ...
    builder:['WEBFACTORY BUILDER + AI','Powerful underneath. Simple on the surface.','Configure your business step by step or ask WebFactory AI with Claude to propose structure, bilingual content, catalog and team inside the same Builder.'],
...
const features = {
  es: [
    ...
    ['WebFactory AI','Claude puede proponer Templates, layouts, colores, contenido bilingüe, catálogo y equipo sin crear deployments separados.'],
  ],
  en: [
    ...
    ['WebFactory AI','Claude can propose Templates, layouts, colors, bilingual content, catalog and team without creating separate deployments.'],
  ],
}
...
const faqEs = [
  ...
  ['¿WebFactory AI crea otra página o deployment aparte?','No. Claude trabaja únicamente dentro del Builder y genera configuración para tu website en /sites/:slug. Todo permanece dentro de la misma plataforma WebFactory.']
]
...
const faqEn = [
  ...
  ['Does WebFactory AI create a separate website or deployment?','No. Claude works only inside the Builder and generates configuration for your website at /sites/:slug. Everything stays inside the same WebFactory platform.']
]
    ...
    <main id="top">
      ...
      <section className="section navy wf-home-ai"><div className="shell split">
        <div className="wf-home-ai-copy">
          <p className="eyebrow">WEBFACTORY AI · CLAUDE</p>
          <h2>{lang==='es'?'Describe tu negocio. Deja que la IA prepare la base.':'Describe your business. Let AI prepare the foundation.'}</h2>
          <p>{lang==='es'?'Dentro del mismo Builder, Claude puede recomendar un Template o Custom, proponer layout, colores, contenido en English + Español, servicios, productos y roles del equipo. Tú revisas la propuesta antes de aplicarla.':'Inside the same Builder, Claude can recommend a Template or Custom, propose layout, colors, English + Spanish content, services, products and team roles. You review the proposal before applying it.'}</p>
          <div className="actions"><a className="btn light" href="/builder">{lang==='es'?'Probar WebFactory AI':'Try WebFactory AI'} →</a></div>
        ...
        <div className="wf-home-ai-card">
          <header><span>✦</span><div><small>WEBFACTORY AI</small><strong>{lang==='es'?'Build or modify with AI':'Build or modify with AI'}</strong></div></header>
