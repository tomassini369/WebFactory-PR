...
const content = {
  es: {
    ...
    hero: {
      ...
      text:'Crea, publica y administra tu website comercial desde un portal privado. Usa Forge AI by WebFactory para construir o modificar contenido y estructura dentro del mismo Builder. Comienza con 48 horas gratis y sin tarjeta.',
    ...
    builder:['WEBFACTORY BUILDER + AI','Avanzado por dentro. Fácil por fuera.','Configura tu negocio paso a paso o pídele a Forge AI by WebFactory que proponga estructura, contenido bilingüe, catálogo y equipo dentro del mismo Builder.'],
  ...
  en: {
    ...
    hero: {
      ...
      text:'Create, publish and manage your commerce website from a private portal. Use Forge AI by WebFactory to build or modify content and structure inside the same Builder. Start with 48 hours free and no card.',
    ...
    builder:['WEBFACTORY BUILDER + AI','Powerful underneath. Simple on the surface.','Configure your business step by step or ask Forge AI by WebFactory to propose structure, bilingual content, catalog and team inside the same Builder.'],
...
const features = {
  es: [
    ...
    ['Forge AI','Forge AI puede proponer Templates, layouts, colores, contenido bilingüe, catálogo y equipo sin crear deployments separados.'],
  ],
  en: [
    ...
    ['Forge AI','Forge AI can propose Templates, layouts, colors, bilingual content, catalog and team without creating separate deployments.'],
  ],
}
...
const faqEs = [
  ...
  ['¿Forge AI crea otra página o deployment aparte?','No. Forge AI trabaja únicamente dentro del Builder y genera configuración para tu website en /sites/:slug. Todo permanece dentro de la misma plataforma WebFactory.']
]
...
const faqEn = [
  ...
  ['Does Forge AI create a separate website or deployment?','No. Forge AI works only inside the Builder and generates configuration for your website at /sites/:slug. Everything stays inside the same WebFactory platform.']
]
    ...
    <main id="top">
      ...
      <section className="section navy wf-home-ai"><div className="shell split">
        <div className="wf-home-ai-copy">
          <p className="eyebrow">FORGE AI · BY WEBFACTORY</p>
          <h2>{lang==='es'?'Describe tu negocio. Deja que la IA prepare la base.':'Describe your business. Let AI prepare the foundation.'}</h2>
          <p>{lang==='es'?'Dentro del mismo Builder, Forge AI puede recomendar un Template o Custom, proponer layout, colores, contenido en English + Español, servicios, productos y roles del equipo. Tú revisas la propuesta antes de aplicarla.':'Inside the same Builder, Forge AI can recommend a Template or Custom, propose layout, colors, English + Spanish content, services, products and team roles. You review the proposal before applying it.'}</p>
          <div className="actions"><a className="btn light" href="/builder">{lang==='es'?'Probar Forge AI':'Try Forge AI'} →</a></div>
        ...
        <div className="wf-home-ai-card">
          <header><span>✦</span><div><small>FORGE AI</small><strong>{lang==='es'?'Build with Forge AI':'Build with Forge AI'}</strong></div></header>
