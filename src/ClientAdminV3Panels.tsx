...
export function PosPanel({site,lang,onSaleComplete}:{site:any;lang:Language;onSaleComplete?:()=>void}){
  ...
  const sendToCard=async()=>{
    ...
    try{
      ...
      setRemoteCheckout({transactionId:result.transactionId,checkoutUrl:result.checkoutUrl})
