...
type LocalizedItem = Pick<TemplateItem, 'name' | 'description'> & {
  displayPrice?: string
  badge?: string
}
...
const localizedTemplates: Record<string, Partial<Record<TemplateLanguage, LocalizedTemplate>>> = {
  'brisa-cocina': {
    es: {
  ...
  'luna-market': {
    es: {
      ...
      description:'Boutique enfocada en catálogo, detalle de producto, carrito y checkout para templatestrar el lado comercial de WebFactory.',
    ...
    en: {
      ...
      description:'A retail boutique focused on catalog, product detail, cart, and checkout to templatenstrate WebFactory’s commerce experience.',
  ...
  'summit-advisory': {
    ...
    en: {
      ...
      description:'A fictional consulting firm templatenstrating professional services, bookable consultations, forms, and calendars.',
...
export const localizeTemplate = (config: TemplateConfig, language: TemplateLanguage): TemplateConfig => {
  const copy = localizedTemplates[config.slug]?.[language]
...
export const templateUi = {
  es: {
    templateNotice:'TEMPLATE PREVIEW · negocio e información de muestra · no se procesan pagos ni reservaciones reales', createWebsite:'Crear mi sitio web ↗',
    ...
    viewAvailability:'Ver disponibilidad', aboutTemplate:'ACERCA DEL TEMPLATE', livePreview:'VISTA PREVIA INTERACTIVA',
    ...
    templateMode:'TEMPLATE WEBFACTORY', availabilityReady:'Reservas listas', commerceReady:'Comercio listo', openCart:'Abrir carrito',
    ...
    templateBy:'Template de WebFactory PR', moreTemplates:'Explorar más Templates de WebFactory →', catalog:'CATÁLOGO', catalogTitle:'Productos y servicios',
    ...
    templateCart:'CARRITO DE PRUEBA', selections:'Tus selecciones', emptyCart:'Tu carrito está vacío.', emptyCartHint:'Añade un producto o servicio para ver la experiencia completa del carrito.', qty:'Cant.', remove:'Eliminar',
    subtotal:'Subtotal', taxes:'Impuestos', calculatedCheckout:'Calculados en checkout', totalPreview:'Total estimado', templateCheckout:'Checkout de prueba',
    ...
    bookingProgress:'Progreso de reserva de prueba', select:'Elegir', checkout:'Checkout', verify:'Verificar', confirmed:'Confirmada', templateBooking:'RESERVA DE PRUEBA', appointment:'Cita',
    ...
    templateCheckoutLabel:'CHECKOUT DE PRUEBA', completeFlow:'Completa el flujo de reserva.', noPaymentInfo:'No se solicita ni transmite información de pago real.', service:'Servicio', professional:'Profesional', dateTime:'Fecha y hora', depositDue:'Depósito a pagar', amountDue:'Total a pagar',
    ...
    confirmBooking:'Confirmar reserva de prueba →', checksVisual:'Estas verificaciones son únicamente una simulación visual. No se contacta ningún servicio externo.', templateConfirmed:'PRUEBA CONFIRMADA', bookingComplete:'Experiencia de reserva completada.',
    bookingStatus:'Estado de la reserva', confirmedTemplate:'CONFIRMADA · PRUEBA', payment:'Pago', verifiedTemplate:'VERIFICADO · PRUEBA', notRequired:'NO REQUERIDO', calendar:'Calendario', eventReady:'EVENTO LISTO · PRUEBA', done:'Finalizar',
  ...
  en: {
    templateNotice:'TEMPLATE PREVIEW · fictional business and information · no real payments or bookings are processed', createWebsite:'Create my website ↗',
    ...
    viewAvailability:'View availability', aboutTemplate:'ABOUT THE TEMPLATE', livePreview:'LIVE FEATURE PREVIEW',
    ...
    templateMode:'WEBFACTORY TEMPLATE', availabilityReady:'Availability ready', commerceReady:'Commerce ready', openCart:'Open cart',
    ...
    templateBy:'Template by WebFactory PR', moreTemplates:'Explore more WebFactory Templates →', catalog:'CATALOG', catalogTitle:'Products and services',
    ...
    templateCart:'TEST CART', selections:'Your selections', emptyCart:'Your cart is empty.', emptyCartHint:'Add a product or service to see the full cart experience.', qty:'Qty', remove:'Remove',
    subtotal:'Subtotal', taxes:'Taxes', calculatedCheckout:'Calculated at checkout', totalPreview:'Total preview', templateCheckout:'Test checkout',
    ...
    bookingProgress:'Test booking progress', select:'Select', checkout:'Checkout', verify:'Verify', confirmed:'Confirmed', templateBooking:'TEST BOOKING', appointment:'Appointment',
    ...
    templateCheckoutLabel:'TEST CHECKOUT', completeFlow:'Complete the booking flow.', noPaymentInfo:'No real payment information is requested or transmitted.', service:'Service', professional:'Professional', dateTime:'Date & time', depositDue:'Deposit due', amountDue:'Amount due',
    ...
    confirmBooking:'Confirm test booking →', checksVisual:'These checks are visual simulation only. No external service is contacted.', templateConfirmed:'TEST CONFIRMED', bookingComplete:'Booking experience complete.',
    bookingStatus:'Booking status', confirmedTemplate:'CONFIRMED · TEST', payment:'Payment', verifiedTemplate:'VERIFIED · TEST', notRequired:'NOT REQUIRED', calendar:'Calendar', eventReady:'EVENT READY · TEST', done:'Done',
...
export type TemplateUi = typeof templateUi.es | typeof templateUi.en
