...
function publicClient(site) {
  ...
  return {
    ...
    templateMode: site.design?.mode || (site.design?.templateSlug ? "template_base" : "custom"),
...
export default async (req) => {
  try {
    ...
    const secretNames = [
      ...
      "MAILJET_SMTP_HOST",
      "MAILJET_SMTP_PORT",
      "WEBFACTORY_EMAIL_FROM_TEAM",
      "WEBFACTORY_EMAIL_FROM_SUPPORT",
      "WEBFACTORY_EMAIL_FROM_BILLING",
      "WEBFACTORY_EMAIL_FROM_INFO",
